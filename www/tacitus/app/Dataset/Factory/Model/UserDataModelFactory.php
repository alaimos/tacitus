...
/**
 * Class UserDataModelFactory
 *
 * @package App\Dataset\Factory\Model
 */
class UserDataModelFactory extends AbstractModelFactory
{
    ...
    {
        $this->source = Source::whereName('userdata')->first();
    }
    ...
    public function getDataset(array $options = [])
    {
        if ($this->dataset === null) {
            ...
            $dataset = new Dataset([
                ...
                'private'     => $this->jobData->getData('private', false),
