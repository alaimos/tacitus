...
@section('content')
        ...
        <div class="col-lg-12">
            <h1 class="page-header">
                ...
                <span class="pull-right">
                    <a href="{{ route('mapped-selections-lists') }}" class="btn btn-info">
    ...
    <!-- /.row -->
    <div class="row">
        <form method="POST" action="{{ route('mapped-selection-do-upload', [$mappedSelection]) }}">
            {{ csrf_field() }}
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h5> &emsp;&ensp; {{$mappedSelection->selection->name }}
                                                mapped to {{$mappedSelection->mapping->name }}
                                        </h5>
                                    </div>
                                </div>
                                <br>
    ...
    <script>
        ...
        $(function () {
            ...
            var t = tbl.dataTable({
                ...
                lengthChange: false,
                ajax:         {
                    url:    '{{ route('galaxyCredential-mappedSelection')}}',  /*da sistemare*/
                    method: 'POST'
                },
                columnDefs:   [
                    {
